package com.conghuy.MyRangeSeekBar.seekbar;
...
import com.conghuy.MyRangeSeekBar.R;
...
public class MyRangeSeekbar extends View {
    ...
    public MyRangeSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MyRangeSeekbar);
        try {
    ...
    public MyRangeSeekbar setCornerRadius(float cornerRadius) {
        this.cornerRadius = cornerRadius;
        return this;
    }

    public MyRangeSeekbar setMinValue(float minValue) {
        this.minValue = minValue;
        this.absoluteMinValue = minValue;
        return this;
    }

    public MyRangeSeekbar setMaxValue(float maxValue) {
        this.maxValue = maxValue;
        this.absoluteMaxValue = maxValue;
        return this;
    }

    public MyRangeSeekbar setMinStartValue(float minStartValue) {
        this.minStartValue = minStartValue;
        this.absoluteMinStartValue = minStartValue;
        return this;
    }

    public MyRangeSeekbar setCenter(int v) {
        this.normalizedCenterValue = v;
        return this;
    }

    public MyRangeSeekbar setMax(int v) {
        this.normalizedMaxValue = v;
        return this;
    }

    public MyRangeSeekbar setMin(int v) {
        this.normalizedMinValue = v;
        return this;
    }

    public MyRangeSeekbar setMaxStartValue(float maxStartValue) {
        this.maxStartValue = maxStartValue;
        this.absoluteMaxStartValue = maxStartValue;
        return this;
    }

    public MyRangeSeekbar setSteps(float steps) {
        this.steps = steps;
        return this;
    }

    public MyRangeSeekbar setGap(float gap) {
        this.gap = gap;
        return this;
    }

    public MyRangeSeekbar setFixGap(float fixGap) {
        this.fixGap = fixGap;
        return this;
    }

    public MyRangeSeekbar setBarHeight(float height) {
        _barHeight = height;
        return this;
    }

    public MyRangeSeekbar setBarColorMode(int barColorMode) {
        this.barColorMode = barColorMode;
        return this;
    }

    public MyRangeSeekbar setBarColor(int barColor) {
        this.barColor = barColor;
        return this;
    }

    public MyRangeSeekbar setBarGradientStart(int barGradientStart) {
        this.barGradientStart = barGradientStart;
        return this;
    }

    public MyRangeSeekbar setBarGradientEnd(int barGradientEnd) {
        this.barGradientEnd = barGradientEnd;
        return this;
    }

    public MyRangeSeekbar setBarHighlightColorMode(int barHighlightColorMode) {
        this.barHighlightColorMode = barHighlightColorMode;
        return this;
    }

    public MyRangeSeekbar setBarHighlightColor(int barHighlightColor) {
        this.barHighlightColor = barHighlightColor;
        return this;
    }

    public MyRangeSeekbar setBarHighlightGradientStart(int barHighlightGradientStart) {
        this.barHighlightGradientStart = barHighlightGradientStart;
        return this;
    }

    public MyRangeSeekbar setBarHighlightGradientEnd(int barHighlightGradientEnd) {
        this.barHighlightGradientEnd = barHighlightGradientEnd;
        return this;
    }

    public MyRangeSeekbar setLeftThumbColor(int leftThumbColorNormal) {
        this.leftThumbColorNormal = leftThumbColorNormal;
        return this;
    }

    public MyRangeSeekbar setLeftThumbHighlightColor(int leftThumbColorPressed) {
        this.leftThumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public MyRangeSeekbar setThumbDrawable(int resId, int type) {
        setThumbDrawable(ContextCompat.getDrawable(getContext(), resId), type);
        return this;
    }

    public MyRangeSeekbar setThumbDrawable(Drawable drawable, int type) {
        setThumbBitmap(getBitmap(drawable), type);
        return this;
    }

    public MyRangeSeekbar setThumbBitmap(Bitmap bitmap, int type) {
    ...
    public MyRangeSeekbar setThumbHighlightDrawable(int resId, int type) {
        setThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId), type);
        return this;
    }

    public MyRangeSeekbar setThumbHighlightDrawable(Drawable drawable, int type) {
        setThumbHighlightBitmap(getBitmap(drawable), type);
        return this;
    }

    public MyRangeSeekbar setThumbHighlightBitmap(Bitmap bitmap, int type) {
    ...
    public MyRangeSeekbar setRightThumbColor(int rightThumbColorNormal) {
        this.rightThumbColorNormal = rightThumbColorNormal;
        return this;
    }

    public MyRangeSeekbar setRightThumbHighlightColor(int rightThumbColorPressed) {
        this.rightThumbColorPressed = rightThumbColorPressed;
        return this;
    }

    public MyRangeSeekbar setDataType(int dataType) {
    ...
    protected float getCornerRadius(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_min_start_value, minValue);
    }

    protected float getMaxStartValue(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_max_start_value, maxValue);
    }

    protected float getSteps(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_steps, NO_STEP);
    }

    protected float getGap(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_gap, 0f);
    }

    protected float getFixedGap(final TypedArray typedArray) {
        return typedArray.getFloat(R.styleable.MyRangeSeekbar_fix_gap, NO_FIXED_GAP);
    }

    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.MyRangeSeekbar_bar_color_mode, MySeekbar.ColorMode.SOLID);
    }

    protected float getBarHeight(final TypedArray typedArray) {
        return typedArray.getDimensionPixelSize(R.styleable.MyRangeSeekbar_bar_height, 0);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.MyRangeSeekbar_bar_color, Color.GRAY);
    }

    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.MyRangeSeekbar_bar_gradient_start, Color.GRAY);
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.MyRangeSeekbar_bar_gradient_end, Color.DKGRAY);
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.MyRangeSeekbar_bar_highlight_color_mode, MySeekbar.ColorMode.SOLID);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.MyRangeSeekbar_bar_highlight_color, Color.BLACK);
    }

    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.MyRangeSeekbar_bar_highlight_gradient_start, Color.DKGRAY);
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.MyRangeSeekbar_bar_highlight_gradient_end, Color.BLACK);
    }

    protected int getThumbColor(final TypedArray typedArray, int type) {
        if (type == LEFT)
            return typedArray.getColor(R.styleable.MyRangeSeekbar_left_thumb_color, Color.BLACK);
    ...
    protected int getThumbColorPressed(final TypedArray typedArray, int type) {
        if (type == LEFT)
            return typedArray.getColor(R.styleable.MyRangeSeekbar_left_thumb_color_pressed, Color.DKGRAY);
        else if (type == RIGHT)
            return typedArray.getColor(R.styleable.MyRangeSeekbar_right_thumb_color_pressed, Color.DKGRAY);
        else
            return typedArray.getColor(R.styleable.MyRangeSeekbar_right_thumb_color_pressed, Color.DKGRAY);
    }
    ...
    protected Drawable getDrawable(final TypedArray typedArray, int type) {
        if (type == LEFT)
            return typedArray.getDrawable(R.styleable.MyRangeSeekbar_left_thumb_image);
        else if (type == RIGHT)
            return typedArray.getDrawable(R.styleable.MyRangeSeekbar_right_thumb_image);
        else return typedArray.getDrawable(R.styleable.MyRangeSeekbar_right_thumb_image);
    }

    protected Drawable getDrawablePressed(final TypedArray typedArray, int type) {
        if (type == LEFT)
            return typedArray.getDrawable(R.styleable.MyRangeSeekbar_left_thumb_image_pressed);
        else if (type == RIGHT)
            return typedArray.getDrawable(R.styleable.MyRangeSeekbar_right_thumb_image_pressed);
        else
            return typedArray.getDrawable(R.styleable.MyRangeSeekbar_right_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.MyRangeSeekbar_data_type, DataType.INTEGER);
    }

    protected boolean isSeekBarTouchEnabled(final TypedArray typedArray) {
        return typedArray.getBoolean(R.styleable.MyRangeSeekbar_seek_bar_touch_enabled, false);
    }

    protected float getDiameter(final TypedArray typedArray) {
        return typedArray.getDimensionPixelSize(R.styleable.MyRangeSeekbar_thumb_diameter, getResources().getDimensionPixelSize(R.dimen.thumb_height));
    }
    ...
    protected void setupBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        if (barColorMode == MySeekbar.ColorMode.SOLID) {
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        if (barHighlightColorMode == MySeekbar.ColorMode.SOLID) {
